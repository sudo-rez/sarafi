...
@Component({
  selector: 'sapc-create',
  templateUrl: './sapc-create.component.html',
  styles: [],
  animations: [
...
export class SAPCCreateComponent implements OnInit {
  ...
  public submit(form: FormGroup): void {
    ...
    this._api.set(`brand/sapc/c`, "POST", {
      id: "createSAPC",
      body: form.value
    }, (res: any): void => {
      this._translate.get("notify.sapc.create").subscribe(text => {
